...
import com.gtlugo.ampere.std.common.block.wire.WireSide;
...
public class ModBlockStateProvider extends BlockStateProvider {
  ...
  public ModBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
    super(output, AmpereStd.MOD_ID, exFileHelper);
  }

  @Override
  protected void registerStatesAndModels() {
    machine(AmpereStd.Blocks.POWER_PLANT);
    machine(AmpereStd.Blocks.FURNACE);
    wire();
  }

  private void simple(AmpereStd.Blocks block) {
  ...
  private void machine(AmpereStd.Blocks block) {
  ...
  private void wire() {
    ...
    simpleBlockItem(AmpereStd.Blocks.WIRE.get(), wire);
    ...
    getMultipartBuilder(AmpereStd.Blocks.WIRE.get()) // Get multipart builder
      .part() // Create part
